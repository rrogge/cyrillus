...
dr <- distance(profile.135_315$l, profile.135_315$b, center$l, center$b)
profile.135_315$dr <- sign(profile.135_315$a - profile.000_180$a[which.min(dr)]) * dr
```
